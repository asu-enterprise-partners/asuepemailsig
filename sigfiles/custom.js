...
function generateSubTitle(elm, elm2) {
  ...
  var value =
    ...
    counter +
    " </label>" +
    '<input class="subValue" type="text" value="' +
    elm +
    '" />' +
    "</div>" +
    '<div class="inputContainer" style="width:45%;">' +
    ...
    counter +
    " </label>" +
    '<input class="subValue2" type="text" value="' +
    elm2 +
    '" />' +
    "</div>" +
...
function fillIt() {
  ...
  $.post("asudata.php", { autoPop: autoPop }, function (data) {
    ...
    if (obj.city != "" && obj.state != "") {
      $("#addLine3").val(
        capitalize(obj.city) + ", " + obj.state + " " + obj.postcode
      );
    }
    updatePhone("#phone");
  });
...
function createLinks(theString, theLinkText, theLink) {
  ...
  var field =
    ...
    linkCnt +
    ' </label>\
     <input class="subValueString" type="text" value="' +
    theString +
    '" />\
     </div>\
     <div class="inputContainer phone">\
     <label> Word(s) To Be Linked ' +
    linkCnt +
    ' </label>\
     <input class="subValueLinkText" type="text" value="' +
    theLinkText +
    '" />\
     </div>\
     <div class="inputContainer phone">\
    ...
    linkCnt +
    ' </label>\
     <input class="subValueLink" type="text" value="' +
    theLink +
    '" />\
     </div>\
     <br class="clear" />\
...
function updateAll() {
  var r = confirm(
    "Please verify that all the information entered in correct and spelled/abbreviated correctly. Press OK to proceed."
  );
  if (r) {
    showMask();
    ...
    if ($("#subsidiary").val() == "realty") {
      // console.log('realty');
      $("#preSubsidiary").html(
        "<strong>University Realty</strong><br />Advancing the Arizona State University Knowledge Enterprise<br /><em>An Affiliate of the ASU Foundation for A New American University</em>"
      );
    } else if ($("#subsidiary").val() == "skysong") {
      // console.log('skysong');
      $("#preSubsidiary").html(
        "<strong>Skysong Innovations</strong><br />Advancing the Arizona State University Knowledge Enterprise"
      );
      ...
      // console.log('asuf');
      $("#preSubsidiary").html(
        "<strong>ASU Foundation for A New American University</strong><br />Serving Arizona State University"
      );
      ...
      $("#preSubsidiary").html(
        "<strong>ASU Foundation for A New American University</strong>"
      );
    ...
    if ($("#phone").val() != "") {
      phoneVal =
        '<strong>o: </strong> <a style="color:#8C1D40; font-size:8pt; font-family:arial, sans-serif;" href="tel:' +
        $("#phone").val() +
        '">' +
        $("#phone").val() +
        "</a>&nbsp;&nbsp;";
    ...
    if ($("#web").val() != "") {
      ...
      $("#preWeb").html(
        '<strong>website: </strong><a style="color:#8C1D40; font-size:8pt; font-family:arial, sans-serif;" href="' +
          webText2 +
          '">' +
          webText +
          "<a/>"
    ...
    $(".subDeptContainerSocial").each(function () {
      ...
      if (title == "https://www.facebook.com/asufoundation/") {
        ...
        title ==
        "https://www.linkedin.com/company/asu-foundation-for-a-new-american-university"
      ) {
        var link = "LinkedIn";
        console.log(link);
...
function createSocialMedia(elm, elm2) {
  ...
  var value =
    '<div class="subDeptContainerSocial">' +
  ...
  //   }
  // }
  value += "</select>" + '</div><br class="clear">';
  // console.log(value);
